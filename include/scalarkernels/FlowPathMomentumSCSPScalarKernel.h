...
template <bool is_ad>
class FlowPathMomentumSCSPScalarKernelTempl
...
public:
  FlowPathMomentumSCSPScalarKernelTempl(const InputParameters & parameters);
...
typedef FlowPathMomentumSCSPScalarKernelTempl<false> FlowPathMomentumSCSPScalarKernel;
typedef FlowPathMomentumSCSPScalarKernelTempl<true> ADFlowPathMomentumSCSPScalarKernel;