...
if "/tmap8/doc/" in script_folder.lower():  # if in documentation folder
    csv_folder = (
        "../../../../test/tests/ver-1n/gold/ver-1n_vector_postproc_30s_line_0015.csv"
    )
...
if "/tmap8/doc/" in script_folder.lower():  # if in documentation folder
    csv_folder = (
        "../../../../test/tests/ver-1n/gold/ver-1n_vector_postproc_500s_line_0066.csv"
    )
else:  # if in test folder
...
ax.plot(
    ...
    c=f"C0",
    linestyle="--",
    label=f"Analytical results - 30s",
)
ax.plot(
    tmap_distance,
    tmap_concentration_on_distance_case2,
...
ax.plot(
    ...
    c=f"C1",
    linestyle="--",
    label=f"Analytical results - 500s",
)
